...
type SearchResults {
    ...
    missing: [Repository!]!
    # Repositories that are excluded from the result set.
    #
    # This list currently applies only to fork and archived repositories, which are excluded by
    # default in search queries.
    excluded: [Repository!]!
